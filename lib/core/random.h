...
namespace Core {
    ...
    struct Random {
        ...
        typedef boost::random::uniform_int_distribution<>                                        ui_distribution_type;
        typedef boost::random::variate_generator<Random::generator_type &, ur_distribution_type> uniform_real_gen_type;
        typedef boost::random::variate_generator<Random::generator_type &, ui_distribution_type> uniform_int_gen_type;
