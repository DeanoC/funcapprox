...
namespace Core {
    ...
    struct VectorALU {
        ...
        virtual void min( const size_t numItems, const_real_array_ptr a, const real test, real_array_ptr o ) const = 0;

        virtual void max( const size_t numItems, const_real_array_ptr a, const real test, real_array_ptr o ) const = 0;

        virtual void abs( const size_t numItems, const_real_array_ptr a, real_array_ptr o ) const = 0;

        virtual void set( const size_t numItems, const real value, real_array_ptr o ) const = 0;
        ...
        virtual bool compareAllLess( const size_t numItems, const_real_array_ptr a, const_real_array_ptr b ) const = 0;
